...
const ProductDetails = () => {
  ...
  // const { state } = router.query; // Access the passed state
  // const tractor = state ? JSON.parse(state) : null; 
  return (
    <div>
      <Header />
              ...
              <div className="grid grid-cols-2 gap-x-8 gap-y-6">
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-sm text-gray-600">
                    ...
                    <li>
                      • PTO shaft and gearbox control for precise implement
                      speed
                    </li>
                  </ul>
                </div>
